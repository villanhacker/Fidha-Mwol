...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'menu', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'menu', fromMe: false, desc:'random anime image '}, (async (message, match) => {
