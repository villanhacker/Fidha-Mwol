...
if (Config.BOT == 'default') mode = 'ᴅᴇᴠᴇʟᴏᴘᴇʀ : ʀᴀᴀsʜɪɪ'
            ...
            const raashi = {
                  ...
                  key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "62895619083555-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "FidhaMwol", "caption": mode , 'jpegThumbnail': fs.readFileSync('botsir.jpg')}}
